...
void helper(ll n, ll asf, ll c1, ll c2, ll c3, ll& ans)
{
    if(asf > n) return ;
    if(c1 and c2 and c3) ans ++;
    helper(n,asf*10+3,c1+1,c2,c3,ans);
    helper(n,asf*10+5,c1,c2+1,c3,ans);
    helper(n,asf*10+7,c1,c2,c3+1,ans);
}
